        ...
        <div className="flex flex-col gap-4 sm:gap-6">
          {(limit ? experiences.slice(0, limit) : experiences).map((exp, i) => (
            <motion.div
              ...
              className="flex flex-col gap-3 sm:gap-6 p-6 sm:p-8 bg-background/80  backdrop-blur-2xl rounded-3xl border border-foreground/[0.08]  shadow-[0_12px_32px_-8px_rgba(0,0,0,0.05)]  hover:shadow-[0_20px_48px_-12px_rgba(0,0,0,0.12)] hover:border-foreground/20 transition-all duration-300"
            >
              <div>
        ...
        <motion.div variants={itemAnim} className="mt-2 sm:mt-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <div
                key={stat.label}
                className="flex flex-col gap-1 p-4 sm:p-6 bg-background/80  backdrop-blur-2xl rounded-2xl border border-foreground/[0.08]  shadow-[0_8px_24px_-6px_rgba(0,0,0,0.04)]"
              >
