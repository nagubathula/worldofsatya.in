    ...
    <div className="min-h-screen text-foreground font-sans selection:bg-foreground selection:text-background relative max-w-7xl mx-auto w-full px-4 sm:px-12">
      ...
      <main className="relative z-10 flex flex-col pt-12 sm:pt-20">
        <div className="px-4 sm:px-0 mb-4">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-md border border-black/5 text-black/70 hover:text-black hover:bg-white transition-all text-xs sm:text-sm font-medium"
          >
